...
public class KisValidationHelperTest
{
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void ValidateUserForKisApi_InvalidKisAppKey_ThrowsInvalidOperationException(string kisAppKey)
    {
        // Arrange
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void ValidateUserForKisApi_InvalidKisAppSecret_ThrowsInvalidOperationException(string kisAppSecret)
    {
        // Arrange
        var user = CreateValidUser();
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void ValidateUserForKisApi_InvalidAccountNumber_ThrowsInvalidOperationException(string accountNumber)
    {
        // Arrange
        var user = CreateValidUser();
    ...
    [Fact]
    public void ValidateUserForKisApi_ExpiredToken_ThrowsInvalidOperationException()
    {
        // Arrange
        var user = CreateValidUser();
    ...
    public void ValidateTokenRequest_InvalidAppSecret_ThrowsArgumentException(string appSecret)
    {
        ...
        Assert.Equal("앱 시크릿은 필수입니다. (Parameter 'appSecret')", exception.Message);
    }
